...
import { inputForm } from "../components/exportable_input_form.js";

let input_container = document.querySelector(".input-form-container");

input_container.innerHTML = inputForm();
